...
- `cad/schematic/` — generated by `/generate-schematic` (gitignored)
- `cad/layout_spec.yaml` — schematic layout declaration (sheet size, block positions)
- `cad/drawing-sheet.kicad_wks` — custom EWAI title block
- `cad/cm4_carrier.kicad_pcb` — routed PCB (manual)
- `output/` — generated deliverables: drawings/, gerbers/, STEP
